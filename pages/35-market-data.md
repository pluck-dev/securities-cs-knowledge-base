...
매수/매도 각 10단계 호가를 포함한다. 상세 구조는 [12. 호가창](12-orderbook)을 참조.
...
호가창(Order Book) 상세 구조와 업데이트 처리는 [12. 호가창](12-orderbook)에서 다룬다. 여기서는 시세 파이프라인 관점의 처리를 요약한다.
...
이전: [34. 신용·파생 기초](34-credit-derivatives) · 다음: [36. 리스크 관리와 컴플라이언스](36-risk-compliance) · [전체 커리큘럼](/curriculum)
