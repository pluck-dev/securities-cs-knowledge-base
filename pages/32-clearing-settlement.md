...
> **선행 학습**: [31. 주문 유형 전체](31-order-types), [30. 시장 구조와 매매제도](30-market-structure)
...
이 부분이 백엔드 개발자가 가장 혼란스러워하는 영역이다. 자세한 계산은 [33. 계좌·원장·손익 계산](33-account-ledger)에서 다루며, 여기서는 T+2와의 관계를 이해한다.
...
- 결제 금액 계산은 반드시 `BigDecimal`로 처리 ([10. BigDecimal 심화](10-bigdecimal-deep) 참조).
...
> 세금 계산 로직은 [33. 계좌·원장·손익 계산](33-account-ledger)에서 상세히 다룬다.
...
이전: [31. 주문 유형 전체](31-order-types) · 다음: [33. 계좌·원장·손익 계산](33-account-ledger) · [전체 커리큘럼](/curriculum)
