...
> 참고: [19. 커스텀 검증](19-custom-validation)
...
> 참고: [12. 호가창과 매칭](12-orderbook), [28. JVM 동시성](28-jvm-concurrency)
...
> 참고: [22. 트랜잭션과 정합성](22-transaction)
...
> 참고: [28. JVM 동시성](28-jvm-concurrency), [22. 트랜잭션과 정합성](22-transaction)
...
> 참고: [30. Kafka 기초](30-kafka), [31. 이벤트 소싱](31-event-sourcing)
...
> 참고: [35. WebSocket과 실시간](35-websocket)
...
이전: [45. 보안 심화](45-security-advanced) · [전체 커리큘럼](/curriculum)
