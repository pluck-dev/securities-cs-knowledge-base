...
> 코루틴의 상세 동작은 [13. 코루틴과 비동기 프로그래밍](13-coroutines.md)에서 다룬다.
...
⚠ 두 스레드가 힙의 같은 객체를 동시에 수정하면 경쟁 조건(Race Condition) 발생!
  ...
  → 자세한 내용: [11. 동시성](11-concurrency.md)
```
...
이전: [16. 개발 환경 구축](16-dev-environment.md) · 다음: [24. 자바 상호운용(Interop)](24-java-interop.md) · [전체 커리큘럼](../CURRICULUM.md)
