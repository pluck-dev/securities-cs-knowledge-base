...
[25. 스프링 코어](25-spring-core.md#2510-프록시-동작-원리와-self-invocation-함정)에서 다룬 self-invocation 문제가 `@Transactional`에서도 그대로 적용됩니다.
...
이전: [26. 스프링 웹 계층: MVC와 WebFlux](26-spring-boot-web.md) · 다음: [03. 스프링 부트 입문](03-spring-boot.md) · [전체 커리큘럼](../CURRICULUM.md)
