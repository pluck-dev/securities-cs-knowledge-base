...
> JDK/JVM의 내부 동작 원리는 [17. JVM 동작 원리](17-jvm-fundamentals.md)에서 상세히 다룬다.
...
이전: [15. 이벤트 기반 아키텍처](15-event-driven.md) · 다음: [17. JVM 동작 원리](17-jvm-fundamentals.md) · [전체 커리큘럼](../CURRICULUM.md)
