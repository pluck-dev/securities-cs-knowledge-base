...
완성된 실행 가능한 코드는 [`examples/OrderProcessor.kt`](../examples/OrderProcessor.kt) 에 있습니다.
...
[`examples/OrderProcessor.kt`](../examples/OrderProcessor.kt) 를 실행하고 값을 바꿔보세요.
