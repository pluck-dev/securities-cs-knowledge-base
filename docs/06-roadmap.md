...
- [ ] [02-kotlin-basics.md](02-kotlin-basics.md) 문법 손에 익히기
- [ ] [`examples/OrderProcessor.kt`](../examples/OrderProcessor.kt) 직접 실행 + 값 바꿔보기
- [ ] 회사 코드 받으면 "주문 1건이 어디서 어디로 흐르나" 따라가 보기

## 2주차 — 스프링 + 흐름 이해

- [ ] Controller → Service → Repository 흐름 직접 따라가며 디버깅
- [ ] 우리 팀 시스템의 위치 파악 (주문? 시세? 계좌?) — [01-overview.md](01-overview.md) 참고
- [ ] 도메인 용어집([09-glossary.md](09-glossary.md))을 **우리 회사 버전**으로 정리
- [ ] JPA인지 MyBatis인지 확인
...
- [ ] 주문 생명주기 전체를 코드로 추적 ([08-architecture.md](08-architecture.md) 대조)
...
다음: [07. 실습: 주문 처리기](07-order-system-tutorial.md)
