...
> **선행 학습**: [04. 증권 도메인 입문](04-securities-domain.md), [09. 용어집](09-glossary.md)
...
거래소에서 정의하는 호가 유형은 증권사 HTS/MTS의 주문 유형과 매핑 관계를 가진다. 자세한 주문 유형은 [31. 주문 유형 전체](31-order-types.md)를 참고한다.
...
- [ ] 휴장일 캘린더 관리 (→ [32. 청산·결제·정산](32-clearing-settlement.md) 참조)
...
이전: [29. 기타 선행 주제](29-misc.md) · 다음: [31. 주문 유형 전체](31-order-types.md) · [전체 커리큘럼](../CURRICULUM.md)
