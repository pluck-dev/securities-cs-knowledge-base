...
> **선행 학습**: [32. 청산·결제·정산](32-clearing-settlement.md), [10. BigDecimal 심화](10-bigdecimal-deep.md)
...
금액 계산의 정확성은 법적 책임과 고객 신뢰에 직결된다. 자세한 BigDecimal 사용법은 [10. BigDecimal 심화](10-bigdecimal-deep.md)를 참고하며, 여기서는 원장·손익 계산에 특화된 정책을 정리한다.
...
이전: [32. 청산·결제·정산](32-clearing-settlement.md) · 다음: [34. 위험관리(RMS)](34-risk-management.md) · [전체 커리큘럼](../CURRICULUM.md)
